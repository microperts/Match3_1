...
{
    public static string ContractId = "0xce12e4901f6617c88717d1fe85f03ceb7f456f5d";
    public static string WalletFrom = "";
    public static string WalletTo = "0xc262264285ec67f0eec8feb3380bea2737cde1d4";
    ...
    async void Start()
    {
        ...
        string response = await EVM.Call(chain, network, ContractId, abi, method, args);
